...
const VoteButtons = ({ memeId, upvotes: initialUpvotes, downvotes: initialDownvotes }: VoteButtonsProps) => {
  ...
  return (
    <div className="flex items-center gap-2 bg-black/90 backdrop-blur-sm rounded-full px-4 py-2 shadow-lg group-hover:opacity-100 hover:opacity-100 transition-opacity duration-200">
      <Button
        variant="ghost"
        size="sm"
        onClick={() => vote('upvote')}
