...
const translations: Translations = {
  en: {
    ...
    "footer.x": "X",
    "footer.copyright": "© 2025 $CUBA",
    "footer.madeBy": "Made by Arugami Labs",
    "footer.addressCopied": "Success!",
    "footer.addressCopiedDesc": "Contract address copied to clipboard",
    "footer.copyError": "Error",
    "footer.copyErrorDesc": "Failed to copy address",
  },
  es: {
    "nav.home": "Inicio",
    "nav.about": "Acerca",
